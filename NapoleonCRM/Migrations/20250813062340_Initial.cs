        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<double>(type: "float(19)", precision: 19, scale: 4, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customer_Country_CountryId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<double>(type: "float(19)", precision: 19, scale: 4, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PotentialValue = table.Column<double>(type: "float(19)", precision: 19, scale: 4, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditsDollars = table.Column<double>(type: "float(19)", precision: 19, scale: 4, nullable: true),
                    ConversionRate = table.Column<double>(type: "float(19)", precision: 19, scale: 4, nullable: true),
